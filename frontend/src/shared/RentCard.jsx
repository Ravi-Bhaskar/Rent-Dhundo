...
const RentCard = ({ rent }) => {
  const { _id, city, photo01, price, featured, reviews, bed, bath, propertyType } = rent;
    ...
    <div className="rent__card">
      <Card>
        <div className="rent__img">
          <img src={`/rent-images/${photo01}`} alt="rent-img" />
        ...
        <CardBody>
          ...
          <h5 className="rent__title">
            <Link to={`/rents/${_id}`}>{bed} BHK House For rent in {city}</Link>
          </h5>
